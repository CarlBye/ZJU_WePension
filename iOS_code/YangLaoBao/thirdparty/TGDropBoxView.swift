...
let TGDropBoxListCellHeight: CGFloat = 40.0
...
//        self.addSubview(self.spaceLine)
        ...
        self.boxArrow = UIImageView(frame: CGRect(x: 0, y: 0, width: 18, height: 12))
        self.boxArrow.image = UIImage(named: "ic_more_down")
    ...
    override func layoutSubviews() {
        ...
        self.boxTitle.frame.size = CGSize(width: self.frame.size.width - 150, height: self.frame.size.height)
        self.boxTitle.frame.origin = CGPoint(x: self.frame.origin.x + 80, y: 0)
...
//        self.boxArrow.sizeToFit()
        self.boxArrow.center = CGPoint(x: self.frame.size.width - 30, y: self.frame.size.height * 0.5)
        
        self.listTableView.frame.origin = CGPoint(x: self.frame.origin.x + 100, y: self.frame.origin.y + self.frame.size.height)
        self.listTableView.frame.size = CGSize(width: self.frame.size.width/3, height: CGFloat(self.items.count) * TGDropBoxListCellHeight)
    }
